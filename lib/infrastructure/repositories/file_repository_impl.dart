...
class FileRepositoryImpl implements FileRepository {
  ...
  @override
  Future<Either<Failure, FileMetadata>> getFileMetadata({required FileModel file, required String folderKey}) {
    ...
    return Future.value(left(const Failure.unexpected('Use EncryptionService to decrypt metadata')));
  }
  ...
  @override
  Future<Either<Failure, FileModel>> saveFileEncrypted({required String folderId, required FileMetadata metadata, required String folderKey}) {
    ...
    return Future.value(left(const Failure.unexpected('Refactor: Use saveFileModel')));
  }
